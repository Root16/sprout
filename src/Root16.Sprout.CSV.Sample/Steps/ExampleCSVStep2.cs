...
public class ExampleCSVStep2(BatchProcessor batcher, ICSVDataSourceFactory csvDataSourceFactory) : BatchIntegrationStep<TestClass1, TestClass1>
{
    private readonly BatchProcessor _batcher = batcher;
    private readonly CSVDataSource<TestClass1> _csvDataSource = csvDataSourceFactory.GetCSVDataSourceByName<TestClass1>("CSV1Copy");
