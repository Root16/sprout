...
public class ExampleExcelStep1 : BatchIntegrationStep<TestClass1, Entity>
{
	...
	public ExampleExcelStep1(
	BatchProcessor batcher,
	IExcelDataSourceFactory excelDataSourceFactory,
	...
	)
	{
		...
		this._csvDataSource = excelDataSourceFactory.GetExcelDataSourceByName<TestClass1>("EXCEL1");
	...
	private readonly ExcelDataSource<TestClass1> _csvDataSource;
